...
//       ),
//       home: MyHomePage(title: 'Google Drive', key: ,),
//     );
//   }
// }
//
...
//
//   @override
//   Future<http.Response> head(Object? url, {required Map<String?, String?> headers}) =>
...
//     var client = GoogleHttpClient(await googleSignInAccount.authHeaders);
//     var drive = ga.DriveApi(client);
//     Object file = await drive.files
//         .get(gdID, downloadOptions: ga.DownloadOptions.fullMedia);
//     print((file as ga.Media).stream);
//
...
//         return List.generate(list.files!.length, (index) =>
//             Row(
//             children: <Widget>[
//             Container(
...
//             ),
//             Expanded(
//               child: Text(list.files![index].name.toString()),
//             ),
//             Container(
...
//                 color: Colors.indigo,
//                 onPressed: () {
//                   _downloadGoogleDriveFile(list.files![index].name.toString(), list.files![index].id.toString());
//                 },
//               ),
//             ),
//           ],
